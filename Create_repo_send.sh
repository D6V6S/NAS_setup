...
then
    ...
    # echo "url = ssh://$user@$host_ip:$port$gitfolderpath/$projname.git" >> $gitfolderpath/$projname.git/config
    ...
    echo "git clone ssh://$user@$host_ip:$port$gitfolderpath/$projname.git" >> $gitfolderpath/file.log
